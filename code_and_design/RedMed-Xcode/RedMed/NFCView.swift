        ...
        NavigationView {
            ScrollView {
                VStack(spacing: 12) {
                    ...
                    SecondaryButton("Preview hosted card in Safari", icon: "safari") { showPublicCard = true }
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        SecondaryButton("Scan your bracelet") { showPublicCard = true }
                    }
                    ...
                    SecondaryButton("Scan emergency bracelet", icon: "qrcode.viewfinder") { showPublicCard = true }

...
#
# Bracelet taps must open https://redmed.pages.dev/get/#d=… as RedMed · 911 · Aid
# (quick, no login, no server, no app). Repo get/index.html is that shell.
#
# Usage:
#   ./scripts/deploy-pages.sh              # local http://127.0.0.1:8787/get/
...
if ! cmp -s get.html get/index.html; then
  echo "get.html and get/index.html differ — sync before deploy." >&2
  exit 1
fi

...
- **Clear vs Erase:** Edit has field-level Clear only (blood type / birth date). Blank-all + Save does **not** wipe Keychain. Full wipe is Help → **Erase All User Data** (Face ID). The physical band is not wiped remotely.

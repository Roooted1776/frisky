...
- **Clear vs Erase:** blanking fields in Edit and Save does **not** wipe Keychain (`persist()` refuses empty). Full wipe is Help → **Erase All User Data** (Face ID). The physical band is not wiped remotely.

...
enum RedMedChrome {
    ...
    static let tabBarHeight: CGFloat = 60.5
...
extension View {
    ...
    /// Small chrome (CTAs, CPR beat) still uses `drawingGroup`. Tab bar
    /// does not — a delayed Metal flatten hitch'd cream drop / Face ID.

...
Out of scope: cloning a passive NFC band (same as photocopying a wallet medical card), social engineering the owner, physical device access after unlock, third-party OS bugs (including iOS Background Tag Reading opening a written NDEF URI when an unlocked phone is held ~1–2″ from the band — Apple path, not RedMed).

...
- **Do not** spend paid ads, ship “available now,” or stand up Shopify until the gate in [`docs/ADVERTISING.md`](ADVERTISING.md) is green (live `/tapper/`, real App Store ID, physical NFC write, 1–10 sample bands). Help → Terms §12 is **ships when ready** — no date promise in ads or captions.

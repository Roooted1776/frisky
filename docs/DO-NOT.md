...
- **Do not** add BLE, Bonjour, Multipeer, Wi‑Fi Aware, or “search local networks for nearby bands.” NTAG216 is passive HF NFC — no battery, no radio to advertise. Owner phones must not Safari-auto-arm SOS on band tap via **Associated Domains** (`docs/associated-domains-restore.md`), not fake proximity scanning.

...
- **Do not** add BLE, Bonjour, Multipeer, Wi‑Fi Aware, or “search local networks for nearby bands.” NTAG216 is passive HF NFC — no battery, no radio to advertise. Band tap must not auto-arm SOS; Associated Domains (`docs/associated-domains-restore.md`) opens the app when installed without stealing someone else’s `#d=`.

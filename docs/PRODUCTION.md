...
| Area | Status |
|------|--------|
| Owner Face ID gate | Open/return (system prompt) plus Edit / Save / Erase; Before you continue toggle can skip. Profile restores on Main appear (device-unlocked Keychain, no Face ID to view) |

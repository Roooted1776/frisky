        ...
        ScrollView {
            VStack(spacing: layout.spaceXL) {
                ...
                VStack(alignment: .leading, spacing: layout.spaceLG) {
                    ...
                    Text("RedMed stores your medical profile on this device only. Find 911 uses location (and optional motion assist) only while that screen is open. Nothing is sent to our servers. RedMed cannot start Apple Crash Detection or Satellite SOS.")
